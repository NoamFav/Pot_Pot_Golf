...
public class RuleBasedBot {
    ...
    public RuleBasedBot(Vector3f startingPosition, Vector3f flagPosition, HeightMap testMap){
    ...
    public void applyVelocities(Ball ball, double velocityX, double velocityZ) {
        ball.setVelocityX(velocityX);
        ball.setVelocityZ(velocityZ);
    }

    public void simulateBallMovement(Ball ball) {
        double[] initialState = {startingPosition.x, startingPosition.z, ball.getVelocityX(), ball.getVelocityZ()};
    ...
    public boolean isInHole(Ball ball, Green green) {
