...
public class GameStateManager {
    ...
    public boolean istKeyWasPressed() {
        return tKeyWasPressed;
    }

    public void settKeyWasPressed(boolean tKeyWasPressed) {
        this.tKeyWasPressed = tKeyWasPressed;
    }
