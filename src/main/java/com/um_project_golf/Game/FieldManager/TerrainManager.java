...
public class TerrainManager {
    ...
    public Terrain getOcean() {
        return ocean;
    }

    public void setOcean(Terrain ocean) {
        this.ocean = ocean;
    }
    ...
    public void setBlendMapTerrain(BlendMapTerrain blendMapTerrain) {
        this.blendMapTerrain = blendMapTerrain;
    }

    public BlendMapTerrain getBlueTerrain() {
        return blueTerrain;
    }

    public void setBlueTerrain(BlendMapTerrain blueTerrain) {
