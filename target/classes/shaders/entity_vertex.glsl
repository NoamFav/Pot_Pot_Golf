...
layout(location = 1) in vec2 textureCoord;  // The texture variable has attribute position 1
layout(location = 2) in vec3 normal; // The normal variable has attribute position 2
...
void main()
{
    ...
    gl_Position = projectionMatrix * viewMatrix * worldPos; // Calculate the screen position of the vertex
